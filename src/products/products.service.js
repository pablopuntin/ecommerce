...
var ProductsService = function () {
    ...
    var ProductsService = _classThis = /** @class */ (function () {
        ...
        ProductsService_1.prototype.getProducts = function (page, limit) {
            return this.productsRepository.getProducts(page, limit);
        };
        ProductsService_1.prototype.addProducts = function () {
            return this.productsRepository.addProducts();
        };
        ProductsService_1.prototype.getProductById = function (id) {
            return this.productsRepository.getProductById(id);
        };
        ProductsService_1.prototype.updateProduct = function (id, product) {
