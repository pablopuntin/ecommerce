...
var CategoriesService = function () {
    ...
    var CategoriesService = _classThis = /** @class */ (function () {
        function CategoriesService_1(categoriesRepository) {
            this.categoriesRepository = categoriesRepository;
        }
        CategoriesService_1.prototype.getAllCategories = function () {
            return this.categoriesRepository.getAllCategories();
        };
        CategoriesService_1.prototype.addCategories = function () {
