...
var UserService = function () {
    ...
    var UserService = _classThis = /** @class */ (function () {
        ...
        UserService_1.prototype.getUsers = function (page, limit) {
        ...
        UserService_1.prototype.deleteUser = function (id, currentUser) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    if (!id) {
                        throw new common_1.NotFoundException("Usuario con id ".concat(id, " no encontrado"));
                    }
                    return [2 /*return*/, this.usersRepository.deleteUser(id, currentUser)];
                });
            });
        };
