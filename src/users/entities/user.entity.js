...
var User = function () {
    ...
    var User = _classThis = /** @class */ (function () {
        function User_1() {
            ...
            this.address = (__runInitializers(this, _country_extraInitializers), __runInitializers(this, _address_initializers, void 0));
    ...
    (function () {
        ...
        _email_decorators = [(0, typeorm_1.Column)({ type: 'varchar', length: 50, unique: true })];
        _password_decorators = [(0, typeorm_1.Column)({ type: 'varchar', length: 70, nullable: false })];
        _phone_decorators = [(0, typeorm_1.Column)({ type: 'bigint' })];
        _country_decorators = [(0, typeorm_1.Column)({ type: 'varchar', length: 50 })];
        _address_decorators = [(0, typeorm_1.Column)({ type: 'varchar', length: 100 })];
        _city_decorators = [(0, typeorm_1.Column)({ type: 'varchar', length: 50 })];
        _isAdmin_decorators = [(0, typeorm_1.Column)({ default: false })];
        _orders_decorators = [(0, typeorm_1.OneToMany)(function () { return order_entity_1.Order; }, function (order) { return order.user; }), (0, typeorm_1.JoinColumn)({ name: 'order_id' })];
