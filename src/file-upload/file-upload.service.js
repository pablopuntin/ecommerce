...
var FileUploadService = function () {
    ...
    var FileUploadService = _classThis = /** @class */ (function () {
        function FileUploadService_1(fileUploadRepository, productRepository) {
            this.fileUploadRepository = fileUploadRepository;
            this.productRepository = productRepository;
        }
        FileUploadService_1.prototype.uploadImage = function (file, productId) {
            return __awaiter(this, void 0, void 0, function () {
                var product, response, updateProduct;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.productRepository.findOneBy({ id: productId })];
                        case 1:
                            product = _a.sent();
                            //Validamos el Id:
                            if (!product) {
                            ...
                            return [4 /*yield*/, this.fileUploadRepository.uploadImage(file)];
                        case 2:
                            response = _a.sent();
