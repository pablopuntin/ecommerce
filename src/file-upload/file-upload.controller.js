...
var FileUploadController = function () {
    var _classDecorators = [(0, swagger_1.ApiBearerAuth)(), (0, common_1.Controller)('files')];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var _instanceExtraInitializers = [];
    var _uploadImage_decorators;
    var FileUploadController = _classThis = /** @class */ (function () {
        function FileUploadController_1(fileUploadService) {
            this.fileUploadService = (__runInitializers(this, _instanceExtraInitializers), fileUploadService);
        }
        FileUploadController_1.prototype.uploadImage = function (productId, file) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.fileUploadService.uploadImage(file, productId)];
                });
            });
        };
        return FileUploadController_1;
    }());
    __setFunctionName(_classThis, "FileUploadController");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _uploadImage_decorators = [(0, roles_decorator_1.Roles)(roles_enum_1.Role.Admin), (0, common_1.UseGuards)(auth_guard_1.AuthGuard, roles_guard_1.RolesGuard), (0, common_1.Put)('uploadImages/:id'), (0, swagger_1.ApiBearerAuth)(), (0, swagger_1.ApiOperation)({ summary: 'cargar imagen para un producto' }), (0, swagger_1.ApiParam)({ name: 'id', description: 'ID del producto', type: String }), (0, swagger_1.ApiConsumes)('multipart/form-data'), (0, swagger_1.ApiBody)({
            ...
            }), (0, swagger_1.ApiResponse)({ status: 201, }), (0, common_1.UseInterceptors)((0, platform_express_1.FileInterceptor)('file')), openapi.ApiResponse({ status: 200, type: Object })];
