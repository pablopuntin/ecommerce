...
var AuthController = function () {
    ...
    var AuthController = _classThis = /** @class */ (function () {
        ...
        AuthController_1.prototype.getAuth = function () {
            return this.authService.getAuth();
        };
        AuthController_1.prototype.signUp = function (user) {
            return this.authService.signUp(user);
        };
        AuthController_1.prototype.signIn = function (loginUserDto) {
    ...
    (function () {
        ...
        _getAuth_decorators = [(0, common_1.Get)(), openapi.ApiResponse({ status: 200, type: String })];
        _signUp_decorators = [(0, common_1.Post)('signup'), openapi.ApiResponse({ status: 201, type: Object })];
        _signIn_decorators = [(0, swagger_1.ApiBearerAuth)('JWT-auth'), (0, common_1.Post)('signin'), openapi.ApiResponse({ status: 201 })];
