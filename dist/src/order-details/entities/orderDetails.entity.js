...
let OrderDetail = class OrderDetail {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { id: { required: true, type: () => String }, price: { required: true, type: () => Number }, products: { required: true, type: () => [require("../../products/entities/product.entity").Product] }, order: { required: true, type: () => require("../../orders/entities/order.entity").Order } };
    }
};
